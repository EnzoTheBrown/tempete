...
public class TopologyT4 {
	...
	public static void main(String[] args) throws Exception {
		...
		builder.setBolt("getRank", new ComputeBonusBolt().withWindow(new BaseWindowedBolt.Count(15)), nbExecutors).shuffleGrouping("masterStream");
		/*Affectation à la topologie du bolt qui émet le flux de sortie, il prendra en input le bolt nofilter*/
		builder.setBolt("exit", new Exit4Bolt(portOUTPUT, ipmOUTPUT), nbExecutors).shuffleGrouping("nofilter");
